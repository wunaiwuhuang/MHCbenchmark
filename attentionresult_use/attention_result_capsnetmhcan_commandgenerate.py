...
output_path = '/data1/wuguojia/data/mhc_benchmark/attentionbase/result/capsnetmhc_an'
...
with open('attention_result_capsnetmhcan_singlecommand.py', 'w') as f:
