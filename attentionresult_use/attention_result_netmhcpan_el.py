...
output_path = '/data1/wuguojia/data/mhc_benchmark/attentionbase/result/netmhcpan_el/'#you have to add / in the end,otherwise lots of redundant files will be created in result folder.
